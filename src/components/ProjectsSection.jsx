...
const projects = [
  {
    id: 1,
    title: "Kabad-Becho",
    description: "Web-Based Scrap Pickup Linkage System",
  ...
  {
    id: 2,
    title: "Eduhub-An educational Platform",
    description:
      "Full-featured  platform with a centralized LMS featuring digital books, tutor videos, and virtual classroom tools.",
  ...
  {
    id: 3,
    title: "Butterflies-Landing Page",
    description:
      "A beautiful landing page website using React and Tailwind.",
